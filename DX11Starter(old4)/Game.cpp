...
void Game::Init()
{
	...
	materi = new Material(*pixelShader, *vertexShader);
	GameEntity ent[] = { GameEntity(*obj1, "Square", *materi), GameEntity(*obj1, "Square", *materi) , GameEntity(*obj2, "Pentagon", *materi) , GameEntity(*obj3, "Star", *materi) , GameEntity(*obj3, "Star", *materi) };
...
void Game::Draw(float deltaTime, float totalTime)
{
	...
	render->RenderUpdate(context, mainCam->GetView(), mainCam->GetProject());
